package ai.gollek.peutui.widgets.streaming;
...
public class MarkdownStreamComponent implements Component {
    ...
    public void render(RenderContext context) {
        ...
        for (int row = 0; row < contentHeight; row++) {
            ...
            if (lineIdx >= 0 && lineIdx < lines.size()) {
                ...
                int visibleWidth = ai.gollek.peutui.core.text.TextMeasure.visibleWidth(line);
    ...
    private void renderScrollIndicator(ai.gollek.peutui.core.buffer.ScreenBuffer buffer,
                                       ai.gollek.peutui.core.layout.Rect area,
    ...
    public boolean handleInput(InputEvent event) {
        if (!(event instanceof ai.gollek.peutui.core.event.KeyEvent key)) {
            return false;
        }
