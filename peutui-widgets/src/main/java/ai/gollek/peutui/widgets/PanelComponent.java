...
public final class PanelComponent implements Component {
    ...
    public void render(RenderContext context) {
        ...
        if (showBorder) {
            ...
            var innerArea = new ai.gollek.peutui.core.layout.Rect(innerX, innerY, innerW, innerH);
    ...
    private void renderBorder(ai.gollek.peutui.core.buffer.ScreenBuffer buffer, 
                              ai.gollek.peutui.core.layout.Rect area, String titleText) {
        int w = area.width();
        int h = area.height();
        int x = area.x();
        int y = area.y();
        ...
        // Middle rows
        String sideRow = AnsiCodes.DIM + vLine + AnsiCodes.RESET + " ".repeat(w - 2) + AnsiCodes.DIM + vLine + AnsiCodes.RESET;
    ...
    @Override
    public boolean handleInput(ai.gollek.peutui.core.event.InputEvent event) {
